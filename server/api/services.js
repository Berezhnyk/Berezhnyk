  ...
  return [
    {
      ...
      description: {
        ...
        cz_CZ: 'Používám Vue, progresivní JavaScript framework, k vytváření interaktivních a dynamických webových rozhraní.',
      },
      icon: 'devicon:vuejs',
      image: null,
    },
    {
      ...
      description: {
        ...
        cz_CZ: 'Používám .Net Core, open-source framework od Microsoftu, k vytváření moderních, multiplatformních aplikací převážně v C#.',
      },
    ...
    },
    {
      ...
      description: {
        ...
        cz_CZ: 'Využívám Azure, cloudovou službu Microsoftu, k nasazení, správě a škálování aplikací na celosvětové úrovni.',
      },
      icon: 'devicon:azure',
      image: null,
    }
